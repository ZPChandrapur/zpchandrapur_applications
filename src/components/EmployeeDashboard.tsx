...
export const EmployeeDashboard: React.FC<EmployeeDashboardProps> = ({ onBack }) => {
  ...
  const getFilteredEmployees = () => {
    return employees.filter(employee => {
      const matchesSearch = !searchTerm || 
        ...
        employee.assigned_clerk?.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const getStats = () => {
    ...
    const assigned = employees.filter(emp => emp.assigned_clerk && emp.assigned_clerk.trim() !== '').length;
  ...
  const handleEditEmployee = (employee: Employee) => {
    setFormData({
      ...
      date_of_assignment: employee.date_of_assignment || '',
  ...
  const handleSaveEmployee = async () => {
    ...
    try {
      const employeeData = {
        ...
        date_of_assignment: formData.date_of_assignment || null,
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">{stats.unassigned} {t('erms.unassigned')}</p>
              </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {paginatedEmployees.length === 0 ? (
                  ...
                  paginatedEmployees.map((employee) => {
                    const department = departments.find(d => d.dept_id === employee.dept_id);
                    const designation = designations.find(d => d.designation_id === employee.designation_id);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <h4 className="text-md font-semibold text-gray-800 mb-4">Department & Position</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
              ...
              {/* Service Details */}
              <div>
                <h4 className="text-md font-semibold text-gray-800 mb-4">Service Details</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
              ...
              {/* Assignment */}
              <div>
                <h4 className="text-md font-semibold text-gray-800 mb-4">Assignment</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('erms.dateOfAssignment')}</label>
                    <input
                      type="date"
