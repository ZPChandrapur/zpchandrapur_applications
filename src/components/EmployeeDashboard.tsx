...
export const EmployeeDashboard: React.FC<EmployeeDashboardProps> = ({ onBack }) => {
  ...
  const handleSaveEmployee = async () => {
    ...
    calculatedRetirementDate = calculateRetirementDate(formData.date_of_birth, formData.cadre);
                ...
                <div>
                  ...
                  <input
                   ...
                   // value={calculateRetirementDate(formData.date_of_birth, formData.Cadre) || ''}
                    value={calculatedRetirementDate ? calculatedRetirementDate.toISOString().split('T')[0] : ''}
                    readOnly
